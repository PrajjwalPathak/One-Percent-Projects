# Web Scraping Kotlin Tutorial Data from Javatpoint

import requests
from bs4 import BeautifulSoup
import pandas as pd

mainURL = "https://www.javatpoint.com/kotlin-tutorial"
...
for url in urls:
    ...
    if link is not None:
        for lin in link:
            pageLinks.append('https://www.javatpoint.com/' + lin.get('href'))
...
df.to_csv('Javatpoint-Kotlin-Data.csv')
