# Web Scraping Python Tutorial Data from Javatpoint

import requests
from bs4 import BeautifulSoup
import pandas as pd

mainURL = "https://www.javatpoint.com/python-tutorial"
...
df.to_csv('Javatpoint-Python-Data.csv')
