# Web Scraping C Tutorial Data from Javatpoint

import requests
from bs4 import BeautifulSoup
import pandas as pd

mainURL = "https://www.javatpoint.com/c-programming-language-tutorial"
    ...
    if images is not None:
        for img in images:
            if not img.get('src').startswith('http'):
                pageImageURLs.append('https://www.javatpoint.com/' + img.get('src'))
            else:
...
df.to_csv('Javatpoint-C-Data.csv')
