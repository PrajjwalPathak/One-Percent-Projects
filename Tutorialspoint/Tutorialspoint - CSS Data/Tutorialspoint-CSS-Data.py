# Web Scraping CSS Tutorial Data from Tutorialspoint

import requests
from bs4 import BeautifulSoup
import pandas as pd

mainURL = "https://www.tutorialspoint.com/css/index.htm"
...
for slug in pages[:-9]:
    if slug.get('href') == '/css/css_quick_guide.htm':
        continue
...
df.to_csv('Tutorialspoint-CSS-Data.csv')
